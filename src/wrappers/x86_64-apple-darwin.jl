# Autogenerated wrapper script for libbluray_jll for x86_64-apple-darwin
...
JLLWrappers.@declare_library_product(libbluray, "@rpath/libbluray.2.dylib")
function __init__()
